        ...
        <div id='home' className='xl:mx-40 md:mx-24 mb-28 md:mb-0 relative'>
            ...
            <div className="w-full pt-10 hidden md:flex justify-between items-center h-screen relative z-20">
                <div className="font-ubuntu font-medium uppercase space-y-4 flex flex-col">
                    <p className="xl:text-3xl md:text-2xl">{props.lng.introduce_1}</p>
                    <p className="xl:text-5xl md:text-3xl pl-6">Younes Akbour</p>
                    <div className='flex items-center xl:text-3xl md:text-2xl self-end'>
                    ...
                    <a className='text-white hover:bg-[#1292ee] font-roboto font-bold tracking-[0.3em] duration-150 ease-in-out hover:tracking-[0.6em] uppercase bg-[#0082E0] px-10 py-2 self-end' href="#about">{props.lng.more_button}</a>
                </div>
                <div className='relative mx-16'>
                    <div className='relative xl:w-[340px] md:w-[240px] w-[220px] xl:h-[360px] h-[260px] border-8 border-[#51B6FF]'>
                        <img className='absolute top-[-15%] right-[10%] xl:w-[340px] md:w-[240px] w-[220px] xl:h-[370px] h-[260px]' src="/static/images/mypic.jpg" alt="my image" />
                    </div>
            ...
            <div className='hidden first-block md:block z-10 absolute top-[26%] right-[25%] w-1/3 xl:h-40 h-24 bg-[#1870B0]'>
            </div>
            <div className='hidden second-block md:block absolute top-[43%] left-[-25%] w-2/3 xl:h-40 h-24 bg-[#ACD0EA]'></div>
            {/* Mobile Hero */}
