        ...
        <div id='about' className="md:space-y-6 space-y-10 pt-20 mb-28 md:mb-0 overflow-hidden">
            ...
            <div className='xl:mx-40 md:mx-24 mx-6 flex justify-end'>
                <div className='relative bg-[#1870B0] xl:w-[24%] sm:w-[36%] w-[66%] h-[44px]'>
                    <button className='absolute uppercase w-full border-4 duration-300 ease-in-out hover:bg-[#129BFF] top-[-20%] hover:top-0 hover:left-0 left-[-5%] text-sm border-[#129BFF] p-2 font-ubuntu font-bold tracking-wide text-white'><a href={props.lng.download} download="cv">{props.lng.resume}</a></button>
                </div>
            </div>
        </div>
    )
